...
The Intel 4001 chip was introduced in 1971 as part of the Intel 4000 family; a fully decoded static Random Access Memory chip, fabricated with P-channel silicon gate MOS technology (10 microns)
...
following SYNC, and select 1 out of 256 words and 1 out of 16 ROM’s.
...
A second mode of operation of hthe ROM is as an Input/output control device.
...
Each I/O pin can be uniquely chosen as either an input or output port by metal option.
