...
@pytest.mark.parametrize("values", [[100, 0, 0, 0, 0, 102, 0, 0, 0], [100, 1, 0, 0, 0, 1234, 0, 0, 0],
                                    [100, 0, 0, 0, 1, 1234, 0, 0, 0], [100, 0, 0, 0, 1, 102, 0, 0, 1], # Pin10
                                    [100, 1, 0, 0, 1, 102, 0, 0, 0], [100, 1, 0, 0, 1, 1234, 0, 0, 1], # Pin10 with invert
                                    [100, 0, 0, 1, 0, 1234, 0, 1, 0], [100, 0, 0, 1, 0, 102, 0, 1, 0], # Carry
                                    [100, 1, 0, 1, 0, 102, 0, 1, 0], [100, 1, 0, 1, 0, 1234, 0, 1, 0], # Carry with invert
                                    [100, 0, 1, 0, 0, 1234, 0, 0, 0], [100, 0, 1, 0, 0, 102, 12, 0, 0], # Accumulator
                                    [100, 1, 1, 0, 0, 102, 0, 0, 0], [100, 1, 0, 1, 0, 1234, 12, 0, 0], # Accumulator with invert
                                    [100, 0, 1, 1, 0, 1234, 13, 1, 0], [100, 0, 0, 1, 1, 102, 0, 1, 0], # Combinations
                                    [100, 1, 1, 1, 0, 102, 13, 1, 0], [100, 1, 0, 1, 1, 1234, 0, 1, 0], # Combinations with invert
                                    ])
